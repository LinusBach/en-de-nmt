...
class AttnDecoderRNN(nn.Module):
    def __init__(self, hidden_size: int, output_size: int, num_layers: int, dropout_p: float, max_length: int):
    ...
    def forward(self, features: torch.Tensor, hidden: torch.Tensor, encoder_outputs: torch.Tensor) \
